          ...
          <div className="flex justify-between mt-6 border-t pt-4 tab-container">
            <button
              ...
              className={`px-4 py-2 transition-all duration-300 ${
                activeTab === "buy" ? "font-bold scale-110" : "text-black"
              }`}
            >
              BUY
            </button>
            <button
              ...
              className={`px-4 py-2 transition-all duration-300 ${
                activeTab === "list" ? "font-bold scale-110" : "text-gray-500"
              }`}
            >
              LIST
            </button>
            <button
              ...
              className={`px-4 py-2 transition-all duration-300 ${
                activeTab === "rent" ? "font-bold scale-110" : "text-gray-500"
              }`}
            >
              RENT
            </button>
            ...
            <button
              ...
              className={`px-4 py-2 transition-all duration-300 ${
                activeTab === "more" ? "font-bold scale-110" : "text-gray-500"
              }`}
            >
              MORE
            </button>
